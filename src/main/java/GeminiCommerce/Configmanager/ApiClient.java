...
import GeminiCommerce.Configmanager.auth.Authentication;
import GeminiCommerce.Configmanager.auth.HttpBasicAuth;
import GeminiCommerce.Configmanager.auth.HttpBearerAuth;
import GeminiCommerce.Configmanager.auth.ApiKeyAuth;
import GeminiCommerce.Configmanager.auth.OAuth;
import GeminiCommerce.Configmanager.auth.RetryingOAuth;
import GeminiCommerce.Configmanager.auth.OAuthFlow;
...
public class ApiClient {
     ...
     * @return a {@link GeminiCommerce.Configmanager.ApiClient} object
     */
    ...
    */
     ...
     * @throws GeminiCommerce.Configmanager.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce.Configmanager.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce.Configmanager.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce.Configmanager.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce.Configmanager.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce.Configmanager.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce.Configmanager.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce.Configmanager.ApiException If fail to serialize the request body object into a string
     */
